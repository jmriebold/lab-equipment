...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reservation.reserved_by'
        db.alter_column(u'equipment_reservation', 'reserved_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Reservation.reserved_by'
        db.alter_column(u'equipment_reservation', 'reserved_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['equipment.Person']))
