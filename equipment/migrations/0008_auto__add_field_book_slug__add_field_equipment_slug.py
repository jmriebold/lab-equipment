...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'equipment_book', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='change-this', max_length=50),
                      keep_default=False)

        # Adding field 'Equipment.slug'
        db.add_column(u'equipment_equipment', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='change-this', max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'equipment_book', 'slug')

        # Deleting field 'Equipment.slug'
        db.delete_column(u'equipment_equipment', 'slug')
