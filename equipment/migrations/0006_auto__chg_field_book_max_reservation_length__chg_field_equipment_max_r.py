...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.max_reservation_length'
        db.alter_column(u'equipment_book', 'max_reservation_length', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Equipment.max_reservation_length'
        db.alter_column(u'equipment_equipment', 'max_reservation_length', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Book.max_reservation_length'
        db.alter_column(u'equipment_book', 'max_reservation_length', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Equipment.max_reservation_length'
        db.alter_column(u'equipment_equipment', 'max_reservation_length', self.gf('django.db.models.fields.IntegerField')(default=0))
