...
urlpatterns = patterns('',
    ...
    url(r'^reserve/make-reservation$', views.make_reservation, name="make_reservation"),
    url(r'^reserve/cancel-confirmation$', views.cancel_confirmation, name="cancel_confirmation"),
    url(r'^reserve/canceled', views.cancel_reservation, name="cancel_reservation"),
    url(r'^reserve/return-details$', views.return_details, name="return_details"),
    url(r'^reserve/returned', views.return_equipment, name="returned"),
